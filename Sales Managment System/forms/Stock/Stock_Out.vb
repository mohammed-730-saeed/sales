...
Public Class Stock_Out
    ...
    Private Sub Stock_Out_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub Insert_Stock_Out_Tbl(ByVal Stock_ID As Int32, ByVal Money As Double, ByVal DateOut As Date, ByVal EmpName As String, ByVal Reason As String)
        Dim Cmd As New SqlCommand
        With Cmd
            .Connection = Con
            .CommandType = CommandType.Text
            .CommandText = "Insert Into Stock_Out_Tbl ( Stock_ID,Money,DateOut,EmpName,Reason)values(@Stock_ID,@Money,@DateOut,@EmpName,@Reason)"
            .Parameters.Clear()
            .Parameters.AddWithValue("@Stock_ID", SqlDbType.Int).Value = Stock_ID
            .Parameters.AddWithValue("@Money", SqlDbType.Decimal).Value = Money
            .Parameters.AddWithValue("@DateOut", SqlDbType.Date).Value = DateOut
    ...
    Private Sub btnAdd_Click(sender As System.Object, e As System.EventArgs) Handles btnAdd.Click
        ...
        Insert_Stock_Out_Tbl(Cmb_Stock.SelectedValue, Money.Text, DateOut.Value, EmpName.Text, Reason.Text)
