...
Public Class Frm_Sql_Setting
    ...
    Sub CreateBlankDB()
        Try
            Con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
            Con.Open()
            Dim sql As String = "Select * from sysdatabases where name='MyNew_Sales_DB'"
            ...
            If rdr.Read() Then
                Con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                Con.Open()
                Dim cb1 As String = "Drop Database MyNew_Sales_DB"
                ...
                Con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                Con.Open()
                Dim sql2 As String = "Create Database MyNew_Sales_DB"
            ...
            Else
                Con = New SqlConnection("Data source=" & cmbServerName.Text & ";Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=True")
                Con.Open()
                Dim cb3 As String = "Create Database MyNew_Sales_DB"
