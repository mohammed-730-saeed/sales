...
Partial Class Edit_Customer
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "تعديل بيانات العميل"
        '
        'CusAddress
        '
